...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleFichaNotFound(
                        FichaNotFoundException ex,
                        HttpServletRequest request) {
        ...
        public ResponseEntity<ErrorResponse> handleExamenNotFound(
                        ExamenNotFoundException ex,
                        HttpServletRequest request) {
